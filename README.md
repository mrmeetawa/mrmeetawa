...
## 👨🏻‍🎓 About Me
   ...
   * 😄 Pronouns: He/Him
   * 👨‍🎓 B.Tech Graduate @ BK Birla Institute of Engineering & Technology ⚙️
   * 👩‍💻 Former React Developer @ Optimizory Technologies Private Limited (Oct 2022 – Oct 2023 · 1 year 2 months)  
   * 👨‍🎓 Currently a GATE aspirant  
...
## 📫 How to reach me:
   * Feel free to reach out to me at:
     * 📧 Email:
       * mr.meetawa@gmail.com
     * 🌐 Portfolio:
       * https://mrmeetawa.github.io/

<!-- ---------------------------------------------------------------- --> 

## 🌐 Follow and 📲 Connect with me on social media 
### Let's be friends! Let me connect with you on
...
## 🚀 Skills & Projects
  ### View my skills, open-source projects and code on: [![Github](https://img.shields.io/badge/Github-%237289DA.svg?logo=Github&logoColor=white)](https://github.com/rahulmeetawa)

<!-- ---------------------------------------------------------------- -->

## 🎯 Interested
In React, Web Performance, Clean Code, playing with HTML & CSS, and exploring browser behaviour.
    
<!-- ---------------------------------------------------------------- -->
   
## ⚡ Fun Fact
I love solving problems, learning new technologies, and improving 1% every day
